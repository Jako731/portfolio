...
export const LinkedInIcon = () => {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" viewBox="0 0 30 30" className="w-6 h-6 text-blue-950 hover:text-blue-900">
...
export default function NavBar() {
    return (
        <nav className="flex sticky bg-blue-100 py-3 px-5 top-0 justify-between text-blue-950 font-sans z-40">
          ...
          <section className="flex divide-x-[2px] divide-black font-semibold">
            {NAV_LINKS.map((link) => {
                return (
                    <a
                      href={link.href}
                      className="px-3 text-blue-950 hover:text-blue-800"
                    >
                      {link.name === "Linked In"
                       ? <LinkedInIcon />
                       : link.name
