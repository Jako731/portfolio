export default function CompanyInfoCard({ className, imageClass, children, title, time, imageUri, href }) {
    return (
        <a
          ...
          />
          <div className="bg-gray-100 w-fit text-primary-950 text-center border-4 border-accent-400 absolute left-1/2 transform -translate-x-1/2 -translate-y-9 d text-xs rounded-xl p-2">
